...
/* ============================================
   DATABASE CONNECTION
   db_connect.php is in: /cocovalley/admin/handlers/db_connect.php
============================================ */
$promos  = [];
$current = basename($_SERVER['PHP_SELF']);

require_once __DIR__ . '/handlers/db_connect.php';  // ✅ CORRECT PATH
...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="nav">
    ...
    <a href="admin-announcement.php" class="nav-item active">
